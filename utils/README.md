# KMPCode-utils Library Documentation

## Introduction

`KMPCode-utils` is a Kotlin Multiplatform library that helps developers more conveniently handle colors, strings, air quality, and more.
